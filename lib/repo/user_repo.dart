...
class UserRepository {
  ...
  UserRepository({@required this.client, this.httpClient});
  ...
  Future<AuthResult> signInWithPhone(
    ...
    try {
      final result = await client.signInWithPhoneNum(
          smsCode: smsCode, verifyCode: verifyCode);
      return result;
    } catch (e) {
  ...
  Stream<DocumentSnapshot> getRealTimeUser(String uid) {
    return Firestore.instance.collection('Client').document(uid).snapshots();
  }
  ...
  Future<void> updateUserInfo(String name, String email) async {
    return await client.updateUserInfo(name, email);
  }

  Future<void> updateGoogleUserInfo(String name, String phone, String email) async {
    return await client.updateGoogleUserInfo(name, phone, email);
  }

  Future<void> setGoogleSignupType() async {
    return await client.setGoogleSignupType();
  }
  ...
  Future<User> fetchUserInfo(String uid) async {
    final doc =
  ...
  Future<void> uploadHelp({
    ...
    final url = BASE_URL + "/sendEmailClient";
    return await http.post(url,
        body: json.encode({
          "option": {
            "from": "Customer Service <noreply@firebase.com>",
            "to": "support@chiplusgo.com",
            "subject": "Help Center",
    ...
    // return await client.uploadHelpRequest(
    //   name: name,
    //   email: email,
    //   phone: phone,
    //   content: content,
