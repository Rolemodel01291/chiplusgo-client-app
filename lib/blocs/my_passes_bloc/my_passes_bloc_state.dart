...
@immutable
abstract class MyPassesBlocState extends Equatable {}

class TicketUninit extends MyPassesBlocState {
  @override
  List<Object> get props => null;
}

class TicketLoaded extends MyPassesBlocState {
...
class TicketLoadding extends MyPassesBlocState {
  @override
  List<Object> get props => null;
}

class TicketLoadError extends MyPassesBlocState {
...
class TicketVerified extends MyPassesBlocState {
...
class TicketVerifing extends MyPassesBlocState {
  @override
  List<Object> get props => null;
}

class TicketVerifiedError extends MyPassesBlocState {
  final String errorMsg;
