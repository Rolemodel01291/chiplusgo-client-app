...
import 'package:infishare_client/blocs/my_passes_bloc/my_passes_bloc_bloc.dart';
...
class MyPassesRoute extends StatefulWidget {
  final String type;
  final String title;
  MyPassesRoute({this.type, this.title});

  @override
  _MyPassesRouteState createState() => _MyPassesRouteState();
}

class _MyPassesRouteState extends State<MyPassesRoute> {
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: <Widget>[
            BlocProvider(
              create: (context) => MyPassesBlocBloc(
                couponRepository: CouponRepository(
                  client: InfiShareApiClient(httpClient: http.Client()),
                ),
              )..add(FetchUserPassesTicket(type: widget.type, used: false)),
